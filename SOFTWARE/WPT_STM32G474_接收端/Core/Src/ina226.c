...
float INA226_GetBusV(void) 
{
	...
	fVoltage = regData * 0.00125f*(1-0.001487023);	///*电压的LSB = 1.25mV*/括号内为误差校准;
	return fVoltage;
}
/*
**************************************************
...
float INA226_GetCurrent() 
{
	...
	fCurrent = regData * 0.00064f;/*电流的LSB = 0.64mA，由用户配置*/
	return fCurrent;
}
/*
**************************************************
...
float INA226_GetPower() 
{
	...
	fPower = regData * 0.016f;/*功率的LSB = 电流的LSB*25,由用户配置*/
	return fPower;
}
